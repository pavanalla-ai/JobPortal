    ...
    const fetchJobs=async()=>{
     ...
     const fetchJobsPost=async()=>{
        ...
        if(response)
        {
           ...
           setJobsPost((prev)=>response.data.filter(e=>
             e.jobtitle===id || e.jobdescription===id ||  e.companyname===id ||  e.jobtype===id ||  e.location===id
           ))
        }
    ...
    return(
        <>
            ...
            <div className="postviewnavigation">
                <div class="searchbar">
                    <input type="text" name="search" placeholder="Job Type, Description, Company, Location"/>
